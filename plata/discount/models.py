...
class DiscountBase(models.Model):
    ...
    TYPE_CHOICES = (
        ...
        (PERCENTAGE_VOUCHER, _("percentage voucher (reduces total tax on order)")),
        (MEANS_OF_PAYMENT, _("means of payment (does not change total tax on order)")),
    )
    ...
    currency = CurrencyField(
        blank=True, null=True, help_text=_("Only required for amount discounts.")
    )
